Note: оригинальный ноутбук может не открыться в гитхабе из-за наличия больших картинок. Поэтому можно посмотреть результаты тут через markdown или локально. 
